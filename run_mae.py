...
from optimizers import SoftSign
...
def main():
    ...
    if training_args.custom_optim == "softsign":
        optim = SoftSign(model.parameters(), beta=0.9, weight_decay=0.05, lr=training_args.learning_rate, eps=training_args.eps)
    else:
        optim = torch.optim.AdamW(model.parameters(), betas = (0.9, 0.95), weight_decay=0.05, lr=training_args.learning_rate)
